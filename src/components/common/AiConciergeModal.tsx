  ...
  const [messages, setMessages] = useState<ConciergeMessage[]>([
    {
      ...
      role: 'assistant',
      mode: 'gemini_fast',
      content: `Hello! I am your specialized **PR Moderator & Concierge** for GSRelation.
    ...
    <>
      ...
      {!isConciergeOpen && (
        <aside
          ...
          aria-label="PR Concierge & Guide"
          className="fixed bottom-5 right-5 z-40 flex items-center group"
        >
          <button
            onClick={() => setIsConciergeOpen(true)}
            className={`w-9 h-9 rounded-full shadow-md flex items-center justify-center transition-all duration-300 hover:scale-105 active:scale-95 border relative group/btn ${
              theme === 'midnight'
                ? 'bg-gradient-to-tr from-[#090D16] via-[#1E293B] to-[#0F1A2C] border-emerald-400/40 text-emerald-300 shadow-emerald-950/40 hover:border-emerald-300'
                : 'bg-gradient-to-tr from-[#14352B] via-[#1C473A] to-[#225546] border-[#B8934C]/50 text-[#FAF8F5] shadow-[#1C473A]/20 hover:border-[#E0C078]'
            }`}
            title="Open PR Concierge & Diagnostic Lab"
            aria-label="Open PR Concierge and Platform Feature Guide"
          >
            <AiModLogo size="xs" variant="floating" glow={true} animated={true} />
            <span className="absolute -top-0.5 -right-0.5 flex h-2 w-2">
              <span
                className={`animate-ping absolute inline-flex h-full w-full rounded-full opacity-75 ${
                  theme === 'midnight' ? 'bg-emerald-400' : 'bg-[#B8934C]'
                }`}
              />
              <span
                className={`relative inline-flex rounded-full h-2 w-2 border ${
                  theme === 'midnight'
                    ? 'bg-emerald-400 border-[#090D16]'
                    : 'bg-[#B8934C] border-[#FAF8F5]'
                }`}
              />
            </span>
          </button>
      ...
      {isConciergeOpen && (
        ...
        >
          <div
            ...
            } h-[94vh] rounded-t-2xl sm:rounded-xl shadow-2xl flex flex-col overflow-hidden border animate-in slide-in-from-bottom-6 duration-200 transition-all ${
              theme === 'midnight'
          ...
          >
            {/* Top Header */}
            <div
              className={`p-3.5 sm:p-4 border-b flex items-center justify-between shrink-0 relative overflow-hidden transition-colors ${
                theme === 'midnight'
                  ? 'bg-[#0B132B] text-white border-slate-800'
                  : 'bg-[#1C473A] text-white border-[#B8934C]/30'
              }`}
            >
              ...
              <div className="flex items-center gap-2.5 relative z-10">
                <AiModLogo size="xs" variant="badge" glow={true} animated={true} />
                <div>
                    ...
                    <h3 id="concierge-heading" className="text-base sm:text-lg font-light tracking-tight text-white flex items-center gap-1.5">
                      ...
                      <span
                        className={`font-serif italic ${
                          theme === 'midnight' ? 'text-emerald-400' : 'text-[#E0C078]'
                        }`}
                      >
                        & War-Room
                      </span>
                    ...
                    <span
                      className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-mono border ${
                        theme === 'midnight'
                          ...
                          : 'bg-white/15 text-[#E0C078] border-[#B8934C]/40'
                      }`}
                    >
                      <span
                        className={`w-1.5 h-1.5 rounded-full animate-pulse ${
                          theme === 'midnight' ? 'bg-emerald-400' : 'bg-[#E0C078]'
                        }`}
                      />
                      Trained Dual-Core
                    </span>
                  ...
                  <p className="text-xs text-white/80 font-light line-clamp-1">
                    Gemini 2.5 Flash Grounded + Strategic Executive Simulator
                  </p>
                </div>
              </div>
                        ...
                        <div className="relative shrink-0 mt-1">
                          ...
                          <span
                            className={`absolute -bottom-0.5 -right-0.5 w-2.5 h-2.5 rounded-full border ${
                              theme === 'midnight' ? 'border-[#090D16]' : 'border-[#FAF8F5]'
                            } ${
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-3 pt-2">
                        <div>
                          ...
                          >
                            <option value="Seed / Pre-Series A">Seed / Pre-Series A (₹8 Cr - ₹25 Cr)</option>
                            <option value="Series A / B">Series A / B (₹40 Cr - ₹200 Cr)</option>
                            <option value="Growth Stage / Pre-IPO">Growth Stage / Pre-IPO (₹400 Cr+)</option>
